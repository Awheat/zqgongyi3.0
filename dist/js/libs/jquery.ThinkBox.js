define(function (require, exports, module) {
    ...
    (function ($) {
        ...
        var ThinkBox = function (element, options) {
            ...
            //给box绑定事件
            box.hover(function () {
                _fire.call(self, options.mouseover)
            }, function () {
                _fire.call(self, options.mouseout)
            })
            ...
            _setLocate(); //设置弹出层显示位置
            options.resize && _win.resize(function () {
                _setLocate()
            });
            ...
            function _hide() {
                if (!visible) return self;
                modal && modal.fadeOut('normal', function () {
                    $(this).remove();
                    modal = null
                });
            ...
            function _setupModal() {
                ...
                _win.resize(function () {
                    modal && modal.css({'width': '', 'height': ''}).css({
                        'width': _doc.width(),
                        'height': _doc.height()
                    });
                });
                    ...
                    default:
                        ...
                        if (options.event) {
                            ...
                            if (event == 'hover') {
                                ...
                                self.hover(
                                    function () {
                                        timeout1 = timeout1 || setTimeout(function () {
                                                _.call(self, options)
                                            }, delayShow)
                                    },
                                    function () {
                                        ...
                                        outClose ? timeout2 = timeout2 || setTimeout(function () {
                                                timeout2 = null;
                                                self.ThinkBox('hide')
