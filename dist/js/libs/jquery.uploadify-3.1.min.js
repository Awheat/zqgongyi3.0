            ...
            init: function (options, swfUploadOptions) {
                return this.each(function () {
                    ...
                    if (flashInstalled) {
                        ...
                        $("#" + swfuploadify.movieName).css({"position": "absolute", "z-index": 1});
                        if (!settings.queueID) {
                            var $queue = $("<div />", {"id": settings.id + "-queue", "class": "uploadify-queue"});
                            $wrapper.after($queue);
        ...
        var handlers = {
            onDialogOpen: function () {
                ...
                if ($.inArray("onSelect", settings.overrideEvents) < 0) {
                    $("#" + settings.queueID).append('<div id="' + file.id + '" class="uploadify-queue-item">					<div class="cancel">						<a href="javascript:$(\'#' + settings.id + "').uploadify('cancel', '" + file.id + '\')">X</a>					</div>					<span class="fileName">' + fileName + " (" + fileSize + ')</span><span class="data"></span>					<div class="uploadify-progress">						<div class="uploadify-progress-bar"><!--Progress Bar--></div>					</div>				</div>')
                }
